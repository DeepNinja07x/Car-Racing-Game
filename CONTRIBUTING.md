...
-  Fork this [repository](https://github.com/DeepNinja07x/Car-Racing-Game)
  
-  Clone the forked https://github.com/<Your_Username>/Car-Racing-Game.git
    > git clone https://github.com/<Your_Username>/Car-Racing-Game.git
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Car-Racing-Game.git
